...
class RecordElementPointer {
	 ...
	 * @param {*} value The value at the current <code>prefixPtr</code> in the
	 * record.
	 * @param {number} prefixDepth Current prefix depth. For the leaf pointer it
	...
	/**
	 * Pointer for the parent record element, or <code>null</code> if root
	 * pointer.
	 *
	...
	/**
	 * Tell if the pointer is the root pointer. Equivalent for checking if
